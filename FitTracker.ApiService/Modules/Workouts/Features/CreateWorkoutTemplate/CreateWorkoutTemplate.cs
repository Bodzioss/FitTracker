...
public static class CreateWorkoutTemplate
{
    public class Endpoint : ICarterModule
    {
        public void AddRoutes(IEndpointRouteBuilder app)
        {
            ...
            {
                var command = new CreateWorkoutTemplateCommand("user-1", request);
    ...
    public class CreateWorkoutTemplateHandler(InMemoryDataStore store) : IRequestHandler<CreateWorkoutTemplateCommand, string>
    {
        public Task<string> Handle(CreateWorkoutTemplateCommand request, CancellationToken cancellationToken)
        {
            ...
            store.WorkoutTemplates.Add(entity);
